...
\begin{figure}
  \begin{center}
   ...
   \end{minipage}%
    ...
    \end{minipage}
  \end{center}
  \caption{WETH/USDC price deviation on CoW, aggregated from September 2021 to March 2023 and separated into buy and sell side for CoW and Univ3. Note that sell side had much larger volume over the period due to general market conditions.}
\end{figure}
...
%We performed merges and data transformations with Polars.\footnote{link to Polar}
