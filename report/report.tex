...
\begin{figure}
  \begin{center} 
    \includegraphics{diagrams/WETH_buy_surplus_discount_median_gas_fee_adj.pdf}
  \end{center}
\end{figure}

\begin{figure}
  \begin{center} 
    \includegraphics{diagrams/WETH_sell_surplus_premium_median_gas_fee_adj.pdf}
  \end{center}
\end{figure}

\begin{figure}
  \begin{center} 
    \includegraphics{diagrams/WETH_buy_surplus_discount_median_gas_fee_adj_scatter.pdf}
  \end{center}
\end{figure}

\begin{figure}
  \begin{center} 
    \includegraphics{diagrams/WETH_sell_surplus_discount_median_gas_fee_adj_scatter.pdf}
  \end{center}
\end{figure}
