...
%
This results in higher volatility of Feedlot compared to the CPMM.
...
\begin{figure}
  \begin{center}
   ...
   \end{minipage}%
    ...
    \end{minipage}
  \end{center}
  \caption{CoW buy (left) and sell (right) side price execution compared to Uniswap v3 and Chainlink}
\end{figure}
...
%
Full details and our codebase are available \footnote{Feedlot Repo https://github.com/mohammed7s/Feedlot}.
