...
%\begin{figure}
%  \begin{center} 
%    \includegraphics[width=\textwidth * \real{0.4}]{diagrams/WETH_buy_surplus_discount_median_gas_fee_adj_scatter.eps}
%  \end{center}
%\end{figure}

%\begin{figure}
%  \begin{center} 
%    \includegraphics[width=\textwidth * \real{0.4}]{diagrams/WETH_sell_surplus_discount_median_gas_fee_adj_scatter.eps}
%  \end{center}
%\end{figure}
